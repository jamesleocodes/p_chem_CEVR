...
space = {'hidden_layer_sizes':hp.choice('hidden_layer_sizes',[(150,100,50), (120,80,40) ,(100,50,30)]),
            'max_iter':hp.choice('max_iter',[5,10,50,100,200]),
...
print('The parameters without lc for mlp have been saved now.')
...
print('The parameters with lc for mlp have been saved now.')

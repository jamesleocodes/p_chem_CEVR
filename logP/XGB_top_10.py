...
col_list = ['PEOE_VSA7','VSA_EState6','PEOE_VSA6','TPSA','MolMR','SMR_VSA7','NumAromaticCarbocycles','BCUT2D_LOGPLOW','EState_VSA8']
...
def run_best_model(arg_1,arg_2):
    ...
    final = pd.DataFrame(data_res,columns = ['', 'Training',' Validation', 'Testing'])
    final.to_excel(dirname+"/logP/results/top_10_mlp_50_rt.xlsx")

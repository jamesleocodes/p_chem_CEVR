...
#col_list = ['PEOE_VSA7','VSA_EState6','PEOE_VSA6','TPSA','EState_VSA8','MolMR','BCUT2D_LOGPLOW','SMR_VSA7','NumAromaticRings']#'EState_VSA8', 'MolMR','BCUT2D_LOGPLOW','SMR_VSA7','NumAromaticRings']
#col_list = ['PEOE_VSA7','VSA_EState6','PEOE_VSA6','TPSA']
col_list = ['PEOE_VSA7','VSA_EState6','PEOE_VSA6','MolMR','BCUT2D_LOGPLOW','NumAromaticRings','SMR_VSA7','EState_VSA8','SlogP_VSA2','VSA_EState8','VSA_EState10','BCUT2D_LOGPHI','SlogP_VSA10','SlogP_VSA5','Kappa3','fr_Ar_OH','EState_VSA1','fr_halogen']
...
#     all_set_df = pd.DataFrame(all_set,columns=['set','mse','rmse','mae','r2'])
#     all_set_df.to_excel(dirname+"/logP/results/top_10_mlp_single_rt.xlsx")
...
def run_best_model(arg_1,arg_2):
    ...
    final = pd.DataFrame(data_res,columns = ['', 'Training',' Validation', 'Testing'])
    final.to_excel(dirname+"/logP/results/top_5_mlp_50_rt.xlsx")

...
def run_best_model(arg_1,arg_2):
    ...
    all_set_df.to_excel(dirname+"/p_chem_logd/results/svm_single_no_rt.xlsx")
...
def run_best_model(arg_1,arg_2):
    ...
    final.to_excel(dirname+"/p_chem_logd/results/svm_50_no_rt.xlsx")
run_best_model(des_df,lc_df)
...
def run_best_model(arg_1,arg_2):
    ...
    all_set_df = pd.DataFrame(all_set,columns=['set','mse','rmse','mae','r2'])
    all_set_df.to_excel(dirname+"/p_chem_logd/results/svm_single_rt.xlsx")
    print('\nSingle random run with LC information is done.')

    # print('\nSingle random run with LC information.')
    # print('train mse',all_set_df[all_set_df['set'] == 'tra']['mse'])
    # print('valid mse',all_set_df[all_set_df['set'] == 'val']['mse'])
    # print('test mse',all_set_df[all_set_df['set'] == 'tes']['mse'])

    # print('train rmse',all_set_df[all_set_df['set'] == 'tra']['rmse'])
    # print('valid rmse',all_set_df[all_set_df['set'] == 'val']['rmse'])
    # print('test rmse',all_set_df[all_set_df['set'] == 'tes']['rmse'])

    # print('train mae',all_set_df[all_set_df['set'] == 'tra']['mae'])
    # print('valid mae',all_set_df[all_set_df['set'] == 'val']['mae'])
    # print('test mae',all_set_df[all_set_df['set'] == 'tes']['mae'])

    # print('train r2',all_set_df[all_set_df['set'] == 'tra']['r2'])
    # print('valid r2',all_set_df[all_set_df['set'] == 'val']['r2'])
    # print('test r2',all_set_df[all_set_df['set'] == 'tes']['r2'])
    # print('\n')
...
def run_best_model(arg_1,arg_2):
    ...
    final = pd.DataFrame(data_res,columns = ['', 'Training',' Validation', 'Testing'])
    final.to_excel(dirname+"/p_chem_logd/results/svm_50_rt.xlsx")

    # print('train mse',all_set_df[all_set_df['set'] == 'tra']['mse'].mean(),'with std', all_set_df[all_set_df['set'] == 'tra']['mse'].std())
    # print('valid mse',all_set_df[all_set_df['set'] == 'val']['mse'].mean(),'with std', all_set_df[all_set_df['set'] == 'val']['mse'].std())
    # print('test mse',all_set_df[all_set_df['set'] == 'tes']['mse'].mean(),'with std',all_set_df[all_set_df['set'] == 'tes']['mse'].std())

    # print('train rmse',all_set_df[all_set_df['set'] == 'tra']['rmse'].mean(),'with std', all_set_df[all_set_df['set'] == 'tra']['rmse'].std())
    # print('valid rmse',all_set_df[all_set_df['set'] == 'val']['rmse'].mean(),'with std', all_set_df[all_set_df['set'] == 'val']['rmse'].std())
    # print('test rmse',all_set_df[all_set_df['set'] == 'tes']['rmse'].mean(),'with std',all_set_df[all_set_df['set'] == 'tes']['rmse'].std())

    # print('train mae',all_set_df[all_set_df['set'] == 'tra']['mae'].mean(),'with std',all_set_df[all_set_df['set'] == 'tra']['mae'].std())
    # print('valid mae',all_set_df[all_set_df['set'] == 'val']['mae'].mean(),'with std',all_set_df[all_set_df['set'] == 'val']['mae'].std())
    # print('test mae',all_set_df[all_set_df['set'] == 'tes']['mae'].mean(),'with std',all_set_df[all_set_df['set'] == 'tes']['mae'].std())

    # print('train r2',all_set_df[all_set_df['set'] == 'tra']['r2'].mean(),'with std',all_set_df[all_set_df['set'] == 'tra']['r2'].std())
    # print('valid r2',all_set_df[all_set_df['set'] == 'val']['r2'].mean(),'with std',all_set_df[all_set_df['set'] == 'val']['r2'].std())
    # print('test r2',all_set_df[all_set_df['set'] == 'tes']['r2'].mean(),'with std',all_set_df[all_set_df['set'] == 'tes']['r2'].std())
    # print('\n')
run_best_model(des_df,lc_df)

...
path = os.getcwd()
dirname = os.path.dirname(path)
file_path = dirname+"/p_chem_logd/hyperparameters/mpl_lc.pkl"
...
plt.xlabel('Predicted LogD by MLP',fontsize = 14)
plt.ylabel('Experimental LogD',fontsize = 14)
plt.savefig(dirname+"/p_chem_logd/results/mlp_vs.png", format='png', dpi=600)# plt.savefig("svm.png", format='png', dpi=600)
plt.show()
...
ax.legend()
plt.savefig(dirname+"/p_chem_logd/results/mlp_lc.png", format='png', dpi=600)
plt.show()
